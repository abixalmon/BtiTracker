    ...
    <td>
      <table width="100%" class="lista">      
        ...
        <tr>
          ...
          <td align="center" width="30" bgcolor="#242424" class="<tag:torrents[].classe_seeds />" style="text-align: center;"><tag:torrents[].seeds /></td>
          <td align="center" width="30" bgcolor="#242424" class="<tag:torrents[].classe_leechers />" style="text-align: center;"><tag:torrents[].leechers /></td>

...
<table cellpadding="4" cellspacing="1" border="0" width="100%" bgcolor="#000000" style="font-family:Verdana;font-size:11px">
  ...
  <if:EDIT_DEL>
  <tr>
    <td class="blocklist" align="center">
  <if:EDIT_NEWS>
    <a href="<tag:news_model[].add />"><tag:language.ADD /></a>&nbsp;&nbsp;&nbsp;<a href="<tag:news_model[].edit />"><tag:language.EDIT /></a>
  </if:EDIT_NEWS>
  <if:DELETE_NEWS>
    &nbsp;&nbsp;&nbsp;<a onclick=\"return confirm('". str_replace("'","\'",<tag:language.DELETE_CONFIRM />)."')\" href="<tag:news_model[].delete />"><tag:language.DELETE /></a></td></tr>
  </if:DELETE_NEWS>
  </if:EDIT_DEL>

    <tr>
<td class="header" align="center"><tag:language.POSTED_BY />: <tag:news_model[].username />&nbsp;|&nbsp;<tag:language.POSTED_DATE />: <tag:news_model[].date /></td>
    </tr>
    <tr>

...
<form action="<tag:frm_action />" method="post">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="4">
    ...
    <tr>
      ...
      <td class="lista" align="center" style="font-weight:<tag:polls[].bold />; white-space: wrap;"><tag:polls[].startdate /></td>
      ...
      <td class="lista" align="center" style="font-weight:<tag:polls[].bold />; white-space: wrap;"><tag:polls[].pollertitle /></td>

...
<form action="<tag:frm_action />" name="level" method="post">
  <table class="lista" width="100%" align="center">
    ...
    <tr>
      <td align="center" class="header"><input type="submit" name="write" value="<tag:language.FRM_CONFIRM />" /></td>
      <td align="center" class="header"><input type="submit" name="write" value="<tag:language.FRM_CANCEL />" /></td>
    </tr>
  </table>
</form>
<else:add_new>

...
require_once(load_language("lang_account.php"));
         ...
         if (!$CURUSER || $CURUSER["id"]==1)
            ...
            <tr><td align="right" class="header"><?php echo $language["USER_NAME"]?>:</td><td class="lista"><input type="text" size="10" name="uid" value="<?php $user ?>" maxlength="40" /></td></tr>
            <tr><td align="right" class="header"><?php echo $language["USER_PWD"]?>:</td><td class="lista"><input type="password" size="10" name="pwd" maxlength="40" /></td></tr>
            ...
            <?php
             ...
             print("\n<form name=\"jump\" method=\"post\" action=\"index.php\">\n<table class=\"lista\" width=\"100%\" cellspacing=\"0\">\n<tr><td align=\"center\" class=\"blocklist\">".$language["USER_NAME"].":  " .unesc($CURUSER["username"])."</td></tr>\n");
             print("<tr><td align=\"center\" class=\"blocklist\">".$language["USER_LEVEL"].": ".$CURUSER["level"]."</td></tr>\n");
             ...
             if ($resmail && mysql_num_rows($resmail)>0)
                {
                 ...
                 if ($mail[0]>0)
                    print("<tr><td class=\"blocklist\" align=\"center\"><a href=\"index.php?page=usercp&amp;uid=".$CURUSER["uid"]."&amp;do=pm&amp;action=list\">".$language["MAILBOX"]."</a> (<font color=\"#FF0000\"><b>$mail[0]</b></font>)</td></tr>\n");
                 else
                     print("<tr><td class=\"blocklist\" align=\"center\"><a href=\"index.php?page=usercp&amp;uid=".$CURUSER["uid"]."&amp;do=pm&amp;action=list\">".$language["MAILBOX"]."</a></td></tr>\n");
                }
             else
             ...
             print("</select>");
             print("</td>\n</tr>\n");
             print("\n<tr><td align=\"center\" class=\"blocklist\"><a href=\"index.php?page=usercp&amp;uid=".$CURUSER["uid"]."\">".$language["USER_CP"]."</a></td></tr>\n");
             if ($CURUSER["admin_access"]=="yes")
                print("\n<tr><td align=\"center\" class=\"blocklist\"><a href=\"index.php?page=admin&amp;user=".$CURUSER["uid"]."&amp;code=".$CURUSER["random"]."\">".$language["MNU_ADMINCP"]."</a></td></tr>\n");

...
function bbcode($content) {
    ...
    $content = preg_replace("(\[(URL|url)\=([$urlchars]*)\](.+?)\[\/(URL|url)\])", '<a href="http://$2">$3</a>', $content);
    
    // [url]uri[/url]
    $content = preg_replace("(\[url\]((http|ftp|https):\/\/([$urlchars]*))\[\/url\])","<a href=\"$2&#58;&#47;&#47;$3\">$2&#58;&#47;&#47;$3</a>",$content);
    // lazy http:// people...
    $content = preg_replace("(\[url\]([$urlchars]*)\[\/url\])","<a href=\"http&#58;&#47;&#47;$1\">http&#58;&#47;&#47;$1</a>",$content);
    ...
    //$content = preg_replace("/\[img\]((http|ftp|https):\/\/([$urlchars]*))\[\/img\]/i","<img src=\"$2&#58;&#47;&#47;$3\" alt=\"\" />",$content);
    $content = preg_replace_callback("/\[img\]((http|ftp|https):\/\/([$urlchars]*))\[\/img\]/i","parseimage",$content);
    $content = preg_replace_callback("/\[img=((http|ftp|https):\/\/([$urlchars]*))\]/i","parseimage",$content);
    ...
    $content = preg_replace("(\[email\]([$urlchars]+)@([$urlchars]+)\[\/email\])","<a href=\"mailto:$1@$2\">$1@$2</a>",$content);

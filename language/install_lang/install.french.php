...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." a besoin de PHP 4.1.2 ou plus et d'une base de donn&eacute;e MYSQL.</p>";
...
$install_lang["settingup_info"]         = "Configuration de base de données";
...
$install_lang["mysql_settings_info"]    = "Configuration de la base de données.";
...
$install_lang["mysql_settings_database"] = "Base de donnée MySQL ";
$install_lang["mysql_settings_prefix"]  = "Préfixe pour la table MySQL ";
...
$install_lang["saved"]                  = "sauv&eacute;e";
...
$install_lang["create_owner_account"]   = "Cr&egrave;ation du compte 'Propriétaire'";
$install_lang["create_owner_account_step"] = "Cr&eacute;ation de 'Propriétaire'";
$install_lang["database_saved"]         = "Le fichier database.sql a &eacute;t&eacute; import&eacute; vers votre base de donn&eacute;e.";
$install_lang["create_owner_account_info"] = "Ici vous pouvez cr&eacute;er le compte 'Propriétaire'.";

...
$install_lang["smf_download"]           = "<strong>Jeżeli wybierasz Simple Machines Forum:</strong><br /><br/ >Proszę ściągnąć najnowszą wersję Simple Machines Forum <a target='_new' href='http://www.simplemachines.org/download/'>stąd</a> i wysłać zawartość archiwum do folderu \"smf\" i <a target='_new' href='smf/install.php'>kliknąć tutaj</a> aby je zainstalować.*<br /><strong>(Proszę użyć tych samych danych uwierzytelniających do bazy których używasz do instalacji trackera.)<br /><br /><font color='#FF0000'>Gdy zainstalujesz</font></strong> kliknij <strong>Następny</strong> aby kontynuować instalację BTI-Tracker.<br /><br /><strong>* Oba linki otworzą się w nowych oknach/zakładkach aby zapobiec wyłączeniu instalatora BTI-Tracker.</strong></p>";

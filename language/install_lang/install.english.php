...
$install_lang["succes_install2a"]       = "<p>You succesfully installed ".$GLOBALS["btit-tracker"]." ".$GLOBALS["current_btit_version"]." on your tracker.</p><p>The installation has been successfully locked to prevent being used again but we advise you to also delete <b>install.php</b> for extra protection.</p>";
$install_lang["succes_install2b"]       = "<p>You succesfully installed ".$GLOBALS["btit-tracker"]." ".$GLOBALS["current_btit_version"]." on your tracker.</p><p>We advise you to lock the installation. You can do this by changing <b>install.unlock</b> to <b>install.lock</b> or to delete this <b>install.php</b> file.</p>";

...
$install_lang["smf_download"]           = "<strong>If using Simple Machines Forum:</strong><br /><br/ >Please download the latest version of Simple Machines Forum <a target='_new' href='http://www.simplemachines.org/download/'>here</a> and upload the contents of the archive to the \"smf\" folder and <a target='_new' href='smf/install.php'>click here</a> to install it.*<br /><strong>(Please use the same database credentials you used for this installation proceedure.)<br /><br /><font color='#FF0000'>Once installed</font></strong> please click <strong>Next</strong> to continue with the BTI-Tracker installation.<br /><br /><strong>* Both links will open into a new window/tab to prevent losing your place on the BTI-Tracker installation.</strong></p>";

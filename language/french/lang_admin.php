...
$language["ALLOW_DEBUG"]="Afficher la fenêtre de debogage d'infos sur la page du bas";
...
$language["USE_POPUP"]="Utiliser une popup pour les détails des torrents";
...
$language["SETTING_MAX_PEERS"]="Nombre max. de peers par requêtes (chiffre)";
...
$language["SETTING_FORUM"]="Le lien du forum, peu etre :<br /><li><font color='#FF0000'>Interne</font> ou vide si vous utilisez le forum interne</li><li><font color='#FF0000'>smf</font> pour intégrer <a target='_new' href='http://www.simplemachines.org'>Simple Machines Forum</a></li><li>Votre propre forum (spécifiez l'url)</li>";
...
$language["BAN_NO_IP_WRITE"]="Vous n'avez pas écrit d'adresse IP. Desolé !";
...
// CENSORED
$language["CENSORED_NOTE"]="Ecrire <b>un mot par ligne</b> pour le censurer (sera transformé en *censuré*)";
...
$language["BLOCK_TITLE"]="Titre du langage (sera utilisé pour afficher le titre traduit)";
...
$language["CANT_DELETE_GROUP"]="Ce niveau/groupe ne peu etre annulé !";
...
$language["GROUP_DELETED"]="Le groupe à bien ete supprimé !";
// MASS PM
...
$language["MASS_PM_ERROR"]="Ecrivez quelque chose avant d'envoyé !!";
...
$language["PRUNE_USERS_INFO"]="Entrez le nombre de jours pendant lesquels les utilisateurs doivent être considéres comme \"inactif\"";
// SEARCH DIFF
...
$language["PRUNE_TORRENTS_INFO"]="Entrez le nombre de jours pendant lesquels les torrents doivent être considéres comme \"inactif\"";
...
$language["HACK_INSTALLED_OK"]="Le hack a été installé avec succès!<br />\nPour voir quelles sont installés hacks revenir au <a href=\"index.php?page=admin&amp;user=".$CURUSER["uid"]."&amp;code=".$CURUSER["random"]."&amp;do=hacks&amp;action=read\">panneau d'administration (Hacks)</a>";
$language["HACK_BAD_ID"]="Erreur de récuperation des informations sur le hack avec cet ID.";
$language["HACK_UNINSTALLED_OK"]="Le hack a été desinstallé avec succès!<br />\nPour voir quelles sont installés hacks revenir au <a href=\"index.php?page=admin&amp;user=".$CURUSER["uid"]."&amp;code=".$CURUSER["random"]."&amp;do=hacks&amp;action=read\">panneau d'administration (Hacks)</a>";
$language["HACK_OPERATION"]="Opération";
$language["HACK_SOLUTION"]="Solution";
// added rev 520
$language["HACK_WHY_FTP"]="Certains fichiers de l'installateur hack ne sont pas inscriptibles. <br />\nVous devez mettre vos fichier en 777 sur votre ftp. <br />\nLes informations de votre FTP peuvent être temporairement misent en cache pour le fonctionnement correct du hack de l'installateur.";

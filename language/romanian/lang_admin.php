...
$language["ACP_LANGUAGES"]="Setari Limba";
$language["ACP_CATEGORIES"]="Setari Categorii";
$language["ACP_TRACKER_SETTINGS"]="Setari Tracker";
$language["ACP_OPTIMIZE_DB"]="Optimizează Baza de Date";
$language["ACP_CENSURED"]="Setări Cuvinte Cenzurate";
$language["ACP_DBUTILS"]="Utilitare Baza de Date";
...
$language["SHOW_UPLOADER"]="Afişează nick'ul Uploader'ului";
$language["USE_POPUP"]="Foloseşte Popup pentru Torrente: detalii/peeri";
...
$language["SETTING_FORUM"]="Link Forul (poate fi: link+ul forumului sau cel intern/necompletat)";
...
// TRADUCERI
$language["LANGUAGE_SETTINGS"]="Setări Limba";
$language["LANGUAGE"]="Limbă";
$language["LANGUAGE_ADD"]="Adaugă o nouă Limba";
...
// CUVINTE CENZURATE
$language["CENSORED_NOTE"]="scrie <b>câte un cuvânt per linie</b> pentru a-l cenyura (va fi afişat ca *censored*)";
...
$language["CANT_FIND_POLL"]="Nu am găsit nici un Chestionar";
$language["ADD_NEW_POLL"]="Adaugă Chestionar";
// GRUPURI
$language["USER_GROUPS"]="Setari Grupuri Utilizatori (apasă pe numele grupului pentru editare)";
...
$language["FORUM_ERR_CANNOT_DELETE_PARENT"]="Nu poţi şterge un forum care are sub-forum(uri), mută-le în alt forum si încearcă din nou";
// MODULE

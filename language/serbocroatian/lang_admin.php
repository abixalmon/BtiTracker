...
$language["ACP_STYLES"]="Stilovi podesavanja";
...
$language["ACP_CENSURED"]="Cenzurisane rijeci podesavanja";
$language["ACP_DBUTILS"]="Alati baze podataka";
$language["ACP_HACKS"]="Hackovi";
$language["ACP_HACKS_CONFIG"]="Hack podesavanja";
...
$language["ACP_SITE_LOG"]="Log trackera";
...
$language["ACP_MYSQL_STATS"]="MySql statistike";
...
$language["DEFAULT_STYLE"]="Osnovni stil";
...
$language["SETTING_MAX_PEERS"]="Maksimum broj aktivnih (peers) za zahtjev (broj u sekundama)";
...
$language["SETTING_CALCULATE_SPEED"]="Racunaj brzinu i downloadovane bytes";
$language["SETTING_PEER_CACHING"]="Kesiranje Mysql stolova (olaksava load servera)";
$language["SETTING_SEEDS_PID"]="Maks broj seedera sa istim PID-om";
$language["SETTING_LEECHERS_PID"]="Maks broj leechera sa istim PID-om";
$language["SETTING_VALIDATION"]="Potvrda";
$language["SETTING_CAPTCHA"]="Sigurna registracija (koristite auto generisan kod na slici, GD+Freetype libraries je potrebno da imate)";
$language["SETTING_FORUM"]="Forum link (moze biti: forum link ili unutrasnji/prazan ili nista)";
$language["BLOCKS_SETTING"]="Podesavanja Index/Blokovi po strani";
$language["SETTING_CLOCK"]="Tip sata";
$language["SETTING_NUM_NEWS"]="Broj zadnjih vijesti (blokova)";
$language["SETTING_NUM_POSTS"]="Broj Forum blokova (broj)";
$language["SETTING_NUM_LASTTORRENTS"]="Broj zadnje uploadovanih torrenata";
$language["SETTING_NUM_TOPTORRENTS"]="Broj najpopularnijih torrenata";
$language["CLOCK_ANALOG"]="Analogni";
$language["CLOCK_DIGITAL"]="Digitalni";
$language["CONFIG_SAVED"]="Konfiguracija je uspjesno sacuvana!";
...
$language["BAN_IP_ERROR"]="Lose IP adrese.";
$language["BAN_NO_IP_WRITE"]="Niste unjelj IP adresu. Oprostite!";
...
// STYLES
$language["STYLE_SETTINGS"]="Stil/Teme podesavanja";
$language["STYLE_EDIT"]="Izmjeni stil";
$language["STYLE_ADD"]="Dodaj novi stil";
$language["STYLE_NAME"]="Naziv stila";
$language["STYLE_URL"]="Stil URL";
$language["STYLE_FOLDER"]="Stil direktorijum ";
$language["STYLE_NOTE"]="U ovoj sekciji mozete vrsiti stil podesavanja, ali prvo morate uploadovati fajlove preko ftp ili sftp.";
// CATEGORIES
...
$language["VIEW_EDIT_DEL"]="Pogled/Izmjena/Izbrisi";
$language["CANT_DELETE_GROUP"]="Ovaj nivo/grupu nemozete otkazati!";
$language["GROUP_NAME"]="Naziv grupe";
$language["GROUP_VIEW_NEWS"]="Vidi vijesti";
$language["GROUP_VIEW_FORUM"]="Vidi forum";
$language["GROUP_EDIT_FORUM"]="Mjenjati forum";
$language["GROUP_BASE_LEVEL"]="Odaberite nivo baze";
$language["GROUP_ERR_BASE_SEL"]="Greska u odabiru nivoa baze!";
...
$language["GROUP_VIEW"]="Pogled";
$language["GROUP_EDIT"]="Izmjena";
$language["GROUP_DELETE"]="Izbrisi";
$language["INSERT_USER_GROUP"]="Dodaj novu korisnicku grupu";
$language["ERR_CANT_FIND_GROUP"]="Ne mozemo pronaci ovu grupu!";
...
$language["RATIO_ONLY"]="samo obaj ratio";
...
// SEARCH DIFF
$language["SEARCH_DIFF"]="Pretraga razlike";
...
// SITE LOG
$language["SITE_LOG"]="Log stranice";
// FORUMS
$language["FORUM_MIN_CREATE"]="Min klasa kreiraj";
$language["FORUM_MIN_WRITE"]="Min klasa pisati";
$language["FORUM_MIN_READ"]="Min klasa citati";
$language["FORUM_SETTINGS"]="Forum podesavanja";
$language["FORUM_EDIT"]="Izmjeni Forum";
$language["FORUM_ADD_NEW"]="Dodaj novi forum";
$language["FORUM_PARENT"]="Poticni (parent) forum";
$language["FORUM_SORRY_PARENT"]="(Oprostite, Nemogu imati poticni, zato sto sam vec i jesam poticni forum)";
...
$language["FORUM_PRUNE_3"]="u protivno idite natrag.";
